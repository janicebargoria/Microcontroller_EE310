...
# 1 "C:/Program Files/Microchip/MPLABX/v6.30/packs/Microchip/PIC18F-K_DFP/1.15.303/xc8\\pic\\include/pic18.inc" 1 3





# 1 "C:/Program Files/Microchip/MPLABX/v6.30/packs/Microchip/PIC18F-K_DFP/1.15.303/xc8\\pic\\include/pic18_chip_select.inc" 1 3
# 254 "C:/Program Files/Microchip/MPLABX/v6.30/packs/Microchip/PIC18F-K_DFP/1.15.303/xc8\\pic\\include/pic18_chip_select.inc" 3
# 1 "C:/Program Files/Microchip/MPLABX/v6.30/packs/Microchip/PIC18F-K_DFP/1.15.303/xc8\\pic\\include\\proc/pic18f47k42.inc" 1 3
# 47 "C:/Program Files/Microchip/MPLABX/v6.30/packs/Microchip/PIC18F-K_DFP/1.15.303/xc8\\pic\\include\\proc/pic18f47k42.inc" 3
...
TOSU equ 03FFFh
# 35665 "C:/Program Files/Microchip/MPLABX/v6.30/packs/Microchip/PIC18F-K_DFP/1.15.303/xc8\\pic\\include\\proc/pic18f47k42.inc" 3
...
# 255 "C:/Program Files/Microchip/MPLABX/v6.30/packs/Microchip/PIC18F-K_DFP/1.15.303/xc8\\pic\\include/pic18_chip_select.inc" 2 3
# 7 "C:/Program Files/Microchip/MPLABX/v6.30/packs/Microchip/PIC18F-K_DFP/1.15.303/xc8\\pic\\include/pic18.inc" 2 3
...
# 15 "newpic_8.asm" 2
# 1 "C:\\Users\\Janice Bargoria\\MPLABXProjects\\Lab 6A\\AssemblyConfig.inc" 1
...
; CONFIG1L
  CONFIG FEXTOSC = LP ; External Oscillator Selection (LP (crystal oscillator) optimized for 32.768 kHz; ((NCO1CON) and 0FFh), 0, b set to low power)
...
; CONFIG1H
  ...
  CONFIG PR1WAY = ON ; ((PRLOCK) and 0FFh), 0, b One-Way Set Enable bit (PRLOCK bit can be cleared and set only once)
  CONFIG CSWEN = ON ; Clock Switch Enable bit (Writing to NOSC and NDIV is allowed)
  CONFIG FCMEN = ON ; Fail-Safe Clock Monitor Enable bit (Fail-Safe Clock Monitor enabled)

; CONFIG2L
  CONFIG MCLRE = EXTMCLR ; MCLR Enable bit (If LVP = 0, MCLR pin is MCLR; If LVP = 1, ((PORTE) and 0FFh), 3, a pin function is MCLR )
  ...
  CONFIG LPBOREN = OFF ; Low Power ((PCON0) and 0FFh), 0, a Enable bit (ULPBOR disabled)
  CONFIG BOREN = SBORDIS ; Brown-out Reset Enable bits (Brown-out Reset enabled , ((BORCON) and 0FFh), 7, b bit is ignored)

; CONFIG2H
  CONFIG BORV = VBOR_2P45 ; Brown-out Reset Voltage Selection bits (Brown-out Reset Voltage (VBOR) set to 2.45V)
  CONFIG ZCD = OFF ; ZCD Disable bit (ZCD disabled. ZCD can be enabled by setting the ((ZCDCON) and 0FFh), 7, b bit of ZCDCON)
...
; CONFIG3L
  ...
  CONFIG WDTE = OFF ; WDT operating mode (WDT Disabled; ((WDTCON0) and 0FFh), 0, b is ignored)
...
; CONFIG4H
  ...
  CONFIG CP = OFF ; ((NCO1CON) and 0FFh), 0, b and Data EEPROM Code Protection bit (((NCO1CON) and 0FFh), 0, b and Data EEPROM code protection disabled)
...
;--------------------------------
MOVLW 15 ; current temperature
MOVWF measuredTemp

MOVLW 5 ; desired temperature
MOVWF refTemp
;--------------------------------
...
MOVLW 2
MOVWF contReg
BSF PORTD,2 ; turn ON cooling (((PORTD) and 0FFh), 2, a)
...
MOVLW 1
MOVWF contReg
BSF PORTD,1 ; turn ON heating (((PORTD) and 0FFh), 1, a)
