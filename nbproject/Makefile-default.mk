...
SOURCEFILES_QUOTED_IF_SPACED=newpic_8.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/newpic_8.o
POSSIBLE_DEPFILES=${OBJECTDIR}/newpic_8.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/newpic_8.o

# Source Files
SOURCEFILES=newpic_8.asm
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Assignment1.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/newpic_8.o: newpic_8.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/newpic_8.o 
	${MP_AS} -mcpu=PIC18F47K42 -c \
	-o ${OBJECTDIR}/newpic_8.o \
	newpic_8.asm \
...
${DISTDIR}/Assignment1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/Assignment1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
