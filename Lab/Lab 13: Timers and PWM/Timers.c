...
void TMR0_Initialize(void)
{
    ...
    T0CON1 = 0x48; // Set T0CS FOSC/4; T0CKPS 1:256; T0ASYNC synchronised; 
    
    //TMR0H = 0x4; // Set TMR0H ;  The total division will be (FOSC/4)/(4+1)x256)))
    TMR0H = 0x28; 
